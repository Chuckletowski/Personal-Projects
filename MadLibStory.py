...
#Ask the user to enter information you can replace in the story such as their name, a place,
#or insert adjectives or adverbs into the story. Then display the personalized story to the user.
